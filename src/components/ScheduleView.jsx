...
import { Search, Star, Edit2, Trash2, QrCode, MessageSquare } from 'lucide-react';
    ...
    <div className={`rounded-xl shadow-sm border overflow-hidden ${
      ...
      <div className={`p-5 border-b flex justify-between items-center ${
        ...
        <div className="relative group">
          <Search className={`absolute left-3 top-1/2 -translate-y-1/2 w-4 h-4 group-focus-within:text-slate-600 transition-colors ${
          ...
          <input
            ...
            className={`pl-10 pr-4 py-2 border rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-slate-900 w-72 transition-all ${
              isDarkMode 
      ...
      {isStudentMode && (
        <div className={`px-5 py-3 border-b ${
          isDarkMode ? 'bg-blue-900/20 border-slate-700' : 'bg-blue-50 border-blue-100'
        }`}>
      ...
      <div className="overflow-x-auto">
        <table className="w-full text-left border-collapse">
          <thead className={`text-xs uppercase font-semibold tracking-wider cursor-pointer border-b ${
            isDarkMode 
            ...
            <tr>
              {isStudentMode && (
                <th className={`px-6 py-4 transition-colors ${
          ...
          <tbody className={`divide-y text-sm ${
            ...
            {getFilteredClasses().length === 0 ? (
              <tr>
                <td colSpan={isStudentMode ? "9" : "9"} className={`px-6 py-8 text-center ${
