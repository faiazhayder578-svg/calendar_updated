...
<<<<<<< HEAD
        ...
        <div className={`px-6 py-4 border-b flex justify-between items-center ${isDarkMode ? 'border-slate-700 bg-gradient-to-r from-teal-900/30 to-[#124d54]/30' : 'border-slate-100 bg-gradient-to-r from-teal-50 to-[#124d54]/10'
          }`}>
          <div className="flex items-center gap-3">
            <div className="p-2 bg-gradient-to-br from-[#124d54] to-[#339fa7] rounded-lg">
=======
          }`}>
        {/* Header with clear title and close button */}
...
<<<<<<< HEAD
          {generatedSchedules.length === 0 ? (
            ...
            <div className="space-y-6">
              ...
              <div className={`p-4 rounded-xl flex items-start gap-3 ${isDarkMode ? 'bg-teal-900/30 border border-teal-700' : 'bg-teal-50 border border-teal-200'
                }`}>
                <Lightbulb className={`w-5 h-5 flex-shrink-0 mt-0.5 ${isDarkMode ? 'text-teal-400' : 'text-teal-600'}`} strokeWidth={1.75} />
                <p className={`text-sm leading-relaxed ${isDarkMode ? 'text-teal-200' : 'text-teal-900'}`}>
              ...
              <div className={`p-4 rounded-xl border flex items-center justify-between ${isDarkMode ? 'bg-slate-700/50 border-slate-600' : 'bg-white border-slate-200'}`}>
                ...
                <div className="flex items-center gap-2">
                  ...
                  <input
                    ...
                    className={`w-20 px-3 py-2.5 border rounded-lg focus:ring-2 focus:ring-teal-500 focus:outline-none focus:border-transparent transition-all duration-200 text-center font-bold ${isDarkMode
                  ...
                  <div className="grid grid-cols-2 gap-4 mb-4">
                    <div className="space-y-1.5">
                      ...
                      <input
                        ...
                        className={`w-full px-4 py-2.5 border rounded-lg text-sm focus:ring-2 focus:ring-teal-500 focus:outline-none focus:border-transparent transition-all duration-200 ${isDarkMode
                  ...
                  <div className="space-y-3">
                        ...
                        {availableDays.map(day => (
                          <button
                            ...
                            className={`flex-1 px-3 py-2.5 rounded-lg text-sm font-medium transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-offset-1 ${slot.preferredDays.includes(day)
                              ? 'bg-teal-600 text-white shadow-md focus:ring-teal-400'
                              : isDarkMode
                        ...
                        {availableTimes.map(time => (
                          <button
                            ...
                            className={`px-3 py-2.5 rounded-lg text-xs font-medium transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-offset-1 ${slot.availableTimes.includes(time)
                              ? 'bg-[#124d54] text-white shadow-md focus:ring-teal-400'
                              : isDarkMode
                                ? 'bg-slate-700 text-slate-300 hover:bg-slate-600 focus:ring-slate-500'
                                : 'bg-white text-slate-700 border border-slate-200 hover:bg-slate-50 focus:ring-slate-400'
                              }`}
                    ...
                    <div className="pt-3 border-t border-slate-200 dark:border-slate-600">
                      <button
                        ...
                        className={`w-full flex items-center justify-between px-4 py-3 rounded-lg font-medium transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-offset-1 ${slot.hasLab
                      ...
                      {expandedLabPanels[slot.id] && (
                        <div className={`mt-3 p-4 rounded-lg border ${isDarkMode
                          ...
                          <div className="flex items-center justify-between mb-4">
                            ...
                            <button
                              ...
                              className={`relative inline-flex h-6 w-11 items-center rounded-full transition-colors duration-200 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-emerald-500 ${slot.hasLab ? 'bg-emerald-600' : isDarkMode ? 'bg-slate-600' : 'bg-slate-300'
                                }`}
                            >
                              <span
                                className={`inline-block h-4 w-4 transform rounded-full bg-white transition-transform duration-200 ${slot.hasLab ? 'translate-x-6' : 'translate-x-1'
                                  }`}
                              />
                            </button>
                          </div>
                                  ...
                                  <div className="grid grid-cols-3 gap-2">
                                    {labDoubleDays.map(day => (
                                      <button
                                        ...
                                        title={day.label}
                                        className={`px-3 py-2 rounded-lg text-xs font-medium transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-offset-1 ${slot.labDays.includes(day.value)
                                  ...
                                  <div className="grid grid-cols-6 gap-2">
                                    {labSingleDays.map(day => (
                                      <button
                                        ...
                                        onClick={() => toggleLabDaySelection(slot.id, day.value)}
                                        title={day.label}
                                        className={`px-2 py-2 rounded-lg text-xs font-medium transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-offset-1 ${slot.labDays.includes(day.value)
                                          ? 'bg-emerald-600 text-white shadow-md focus:ring-emerald-400'
                                          : isDarkMode
                                            ? 'bg-slate-700 text-slate-300 hover:bg-slate-600 focus:ring-slate-500'
                                            : 'bg-slate-50 text-slate-700 border border-slate-200 hover:bg-slate-100 focus:ring-slate-400'
                                    ...
                                    <div className="grid grid-cols-1 gap-1.5">
                                      {labTimeSlots.filter(t => t.duration === '3hr').map(time => (
                                        <button
                                          ...
                                          className={`px-3 py-2 rounded-lg text-xs font-medium transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-offset-1 ${slot.labTimes.includes(time.value)
                                            ? 'bg-emerald-600 text-white shadow-md focus:ring-emerald-400'
                                            : isDarkMode
                                              ? 'bg-slate-700 text-slate-300 hover:bg-slate-600 focus:ring-slate-500'
                                              : 'bg-slate-50 text-slate-700 border border-slate-200 hover:bg-slate-100 focus:ring-slate-400'
                ...
                <div key={idx} className={`p-5 rounded-xl border ${isDarkMode ? 'bg-slate-700/30 border-slate-600' : 'bg-slate-50 border-slate-200'
                  ...
                  <div className="flex justify-between items-start mb-4">
                          ...
                          <table className="w-full text-xs text-left">
                            ...
                            <tbody className={`divide-y ${isDarkMode ? 'divide-slate-700' : 'divide-slate-100'}`}>
                              {schedule.workload.map((w, i) => (
                                <tr key={i} className={isDarkMode ? 'bg-slate-800/50' : 'bg-white'}>
                                  <td className="px-3 py-2.5 font-medium">{w.name}</td>
                                  <td className="px-3 py-2.5 font-bold text-teal-500">{w.count}</td>
                                </tr>
                              ))}
                            </tbody>
                          </table>
                    ...
                    <button
                      onClick={() => handleApplySchedule(schedule)}
                      disabled={isSaving}
                      className={`flex items-center gap-2 px-4 py-2.5 rounded-xl font-semibold transition-all duration-200 shadow-md focus:outline-none focus:ring-2 focus:ring-emerald-400 focus:ring-offset-2 active:scale-[0.98] ${isSaving
                        ? 'bg-slate-400 cursor-not-allowed text-white'
                        : 'bg-gradient-to-r from-emerald-600 to-green-600 hover:from-emerald-700 hover:to-green-700 text-white'
                        }`}
                    >
                      ...
                      <tbody className={`divide-y ${isDarkMode ? 'divide-slate-700' : 'divide-slate-100'}`}>
                        {schedule.classes.map((cls, clsIdx) => (
                          ...
                          >
                            ...
                            <td className="px-4 py-3 font-medium text-teal-500">{cls.section}</td>
                            <td className={`px-4 py-3 ${isDarkMode ? 'text-slate-300' : 'text-slate-600'}`}>{cls.faculty}</td>
                            <td className="px-4 py-3">
                              <span className={`px-2.5 py-1 rounded-lg text-xs font-medium ${isDarkMode ? 'bg-slate-700 text-slate-300' : 'bg-slate-100 text-slate-700'}`}>
                                {cls.days}
